...
```{r echo=FALSE}
census_api_key("560e1d5588de380d3db8f5d13e7248b252f68cd4", overwrite=TRUE)
```
...
**Answer** No, the margins of error between the two counties completely overlap.

Is the difference between Howard and everyone else significant?
**Answer** Yes, Howard County's margin of error does not come close to overlapping with Calvert County's.
...
**Answer** None of the counties saw their median incomes fall from 2010-2020. However, Caroline and Somerset counties 2020 estimates were still within the margin of error for their 2010 incomes.
...
**Answer** Only 21202, it has a median household income of $47,848
...
**Answer** Why are the total contributions for these zip codes so stark in difference? One is $50 while another has over 1.5 million. 