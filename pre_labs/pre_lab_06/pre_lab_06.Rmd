...
**Answer** it added a column header to the jurisdiction wide column named x1. Also Bend and Absentee have missing data.
...
**Answer** it made a new row of data for the jurisdiction wide heading, giving no data in each of the corresponding columns. the dashes that were in the absentee row of data have turned to "NA." also the x1 was renamed as "precinct." The problem that still exists is the rows of data that have NA in the cells.
