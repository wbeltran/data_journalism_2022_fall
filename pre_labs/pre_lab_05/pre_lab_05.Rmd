...
**Answer** Some things have the same name but are spelled slightly differently, which R sees as a completely different item, it can lead to grouping issues.
...
**Answer** "JOE'S SEAFOOD PRIME STEAK & STONE CRAB" had a comma added to be "JOE'S SEAFOOD, PRIME STEAK & STONE CRAB" in recipient_clean. "LE DIMPLOMATE, LE DIPLOMATE" was changed to simply "LE DIMPLOMATE" in recipient_clean.
...
**Answer** "W. MILLAR & CO" was changed to "W. MILLAR AND CO." in recipient_clean. "HILTON WASHINGTON" was changed to "WASHINGTON HILTON" in recipient_clean. "PIZZA, WE THE" was changed to "WE THE PIZZA" in recipient_clean.
...
**Answer** No, recipient_name and recipient_clean seem the same, at least for the ones that I saw.
